...
document.addEventListener("DOMContentLoaded", function() {
  ...
  (function() {
    var CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vSfWTtG5dggKiw6uZIwDyHeWHEjI2Rx0bvHVsSX_NUxt76f66A4lB-w2tjAbD5NCpBvUg1kOnCIyCxG/pub?output=csv";
...
function adminAgregarProducto() {
  ...
  formData.append("upload_preset", "banger-admin");

  fetch("https://api.cloudinary.com/v1_1/dera5nuj6/image/upload", {
    method: "POST",
    body: formData
  })
